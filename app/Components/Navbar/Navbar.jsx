        ...
        <div className='w-full px-[30px] py-4 bg-white flex justify-between items-center'>
            ...
            <div className='block md:hidden'>
                <Menu
                    onClick={toggleMenu} />
                {menuOpen && (
                    <div className="absolute right-10 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-10 border-2 border-gray-800">
                        <h1 className='px-6 py-2 '>Crypto Taxes</h1>
                        <h1 className='px-6 py-2 '>Free Tools</h1>
                        <h1 className='px-6 py-2 '>Resource Center</h1>
                    </div>
                )}
            </div>
        </div>
